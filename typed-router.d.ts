...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'campaigns-components-chat-log-campaign': RouteRecordInfo<'campaigns-components-chat-log-campaign', '/campaigns/components/ChatLogCampaign', Record<never, never>, Record<never, never>>,
    ...
    'campaigns-steps-step-three-providers': RouteRecordInfo<'campaigns-steps-step-three-providers', '/campaigns/steps/StepThreeProviders', Record<never, never>, Record<never, never>>,
    'campaigns-steps-step-two-contacts': RouteRecordInfo<'campaigns-steps-step-two-contacts', '/campaigns/steps/StepTwoContacts', Record<never, never>, Record<never, never>>,
    ...
    'contatos-add': RouteRecordInfo<'contatos-add', '/contatos/add', Record<never, never>, Record<never, never>>,
    'contatos-list': RouteRecordInfo<'contatos-list', '/contatos/list', Record<never, never>, Record<never, never>>,
    ...
    'grupo-contato-add': RouteRecordInfo<'grupo-contato-add', '/grupo-contato/add', Record<never, never>, Record<never, never>>,
    'grupo-contato-list': RouteRecordInfo<'grupo-contato-list', '/grupo-contato/list', Record<never, never>, Record<never, never>>,
