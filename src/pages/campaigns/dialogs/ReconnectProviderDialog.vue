...
const startTimer = async () => {
  ...
  if (status === "open") {
    ...
    $toast.success("Caixa de saída reconectada com sucesso")
    emit("next")
    return
  }
  ...
  <VDialog v-model="isOpen" max-width="420">
    ...
    <VCard>
      ...
      <VCardTitle class="text-h6 font-weight-bold">
        Reconectar caixa de saída
      </VCardTitle>

      <VCardText class="text-center">

        <p class="text-medium-emphasis mb-4">
          Abra o WhatsApp no celular e escaneie o QR Code para reconectar <strong>{{ props.name }}</strong>.
        </p>
